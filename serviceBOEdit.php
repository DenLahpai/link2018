                ...
                <form class="form ServiceBo" action="#" method="post">
                    <ul>
                        ...
                        <li>
                            ...
                            value="<?php echo $row_Cost->StartDate; ?>">
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <input type="number" name="MaxPax" id="MaxPax"
                            value="<?php echo $row_Cost->MaxPax; ?>" min="1" required>
                        </li>
                        <li>
                            <label for="Cost1_USD">Cost in USD:</label>
                            <input type="number" name="Cost1_USD" id="Cost1_USD"
                            step="0.01" value="<?php echo $row_Cost->Cost1_USD; ?>">
                        </li>
                        <li>
