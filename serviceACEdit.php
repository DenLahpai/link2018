...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_Cost->bind(':Cost2_USD', $Cost2_USD);
    $update_Cost->bind(':Cost2_MMK', $Cost2_MMK);
    $update_Cost->bind(':Cost3_USD', $Cost3_USD);
    $update_Cost->bind(':Cost3_MMK', $Cost3_MMK);
